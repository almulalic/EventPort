...
class EventServiceTests {
  ...
  //  @Test
  //  void getUserLikedEvents() {
  //    Pageable pageable = Pageable.unpaged();
  //    Page<Event> mockedPage = mock(Page.class);
  //
  //    when(eventRepository.findUserCreatedEvents(adminId, pageable))
  //      .thenReturn(mockedPage);
  //
  //    assertEquals(mockedPage, eventService.getEvents(type, status, pageable));
  //    verify(eventRepository).findUserLikedEvents(type, status, pageable);
  //  }
  ...
  //    Page<Event> mockedPage = mock(Page.class);
  //
  //    when(eventRepository.findUserLikedEvents(type, status, pageable))
  //      .thenReturn(mockedPage);
  //
  //    assertEquals(mockedPage, eventService.getEvents(type, status, pageable));
